...
public class DiscountController {
	...
	final String var_function_name = "discount"; // small letter
	final String disp_function_name = "Discount"; // capital letter
	...
	public ModelAndView add() {
		...
		mav.addObject("action_name", var_function_name);
		Discount objEnt = new Discount();
		mav.addObject("objEnt", objEnt);
		return mav;
	}

	@PostMapping("/save")
	public String save(Discount obj, RedirectAttributes redirectAttributes) {
		try {
			repository.save(obj);
