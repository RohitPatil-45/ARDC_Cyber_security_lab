...
import in.canaris.cloud.repository.AnnouncementRepository;
...
public class AnnoucementController {
	...
	final String var_function_name = "announcement"; // small letter
	final String disp_function_name = "Announcement"; // capital letter
	...
	public ModelAndView add() {
		...
		mav.addObject("action_name", var_function_name);
		Announcement objEnt = new Announcement();
		mav.addObject("objEnt", objEnt);
		return mav;
	}

	@PostMapping("/save")
	public String save(Announcement obj, RedirectAttributes redirectAttributes) {
		try {
			repository.save(obj);
