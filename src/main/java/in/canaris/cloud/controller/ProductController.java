...
public class ProductController {
	...
	final String var_function_name = "product"; // small letter
	final String disp_function_name = "Product"; // capital letter
	...
	public ModelAndView add() {
		...
		mav.addObject("action_name", var_function_name);
		Product objEnt = new Product();
		mav.addObject("objEnt", objEnt);
		return mav;
	}

	@PostMapping("/save")
	public String save(Product obj, RedirectAttributes redirectAttributes) {
		try {
			repository.save(obj);
