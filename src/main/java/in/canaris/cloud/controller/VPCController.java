...
public class VPCController {
	...
	final String var_function_name = "vpc"; // small letter
	final String disp_function_name = "VPC"; // capital letter
	...
	@PostMapping("/save")
	public String save(VPC obj, RedirectAttributes redirectAttributes) {
		try {
			repository.save(obj);
